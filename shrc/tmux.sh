...
# Copy of https://github.com/imomaliev/tmux-bash-completion/blob/master/completions/tmux
# Wich is a copy of https://github.com/Bash-it/bash-it/blob/master/completion/available/tmux.completion.bash
